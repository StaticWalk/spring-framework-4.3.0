...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	...
	public Object applyBeanPostProcessorsAfterInitialization(Object existingBean, String beanName)
		...
		Object result = existingBean;
		for (BeanPostProcessor beanProcessor : getBeanPostProcessors()) {
			//触发调用AbstractAutoProxyCreator的PostProcessorAfterInitialization();
	...
	protected Object createBean(String beanName, RootBeanDefinition mbd, Object[] args) throws BeanCreationException {
		...
		try {
			// Give BeanPostProcessors a chance to return a staticProxy instead of the target bean instance.
			// aop的入口
		...
		if (earlySingletonExposure) {
			...
			addSingletonFactory(beanName, new ObjectFactory<Object>() {
				...
				public Object getObject() throws BeansException {
					//对bean再一次依赖引用，主要应用SmartInstantiationAware BeanPostProcessor,AOP在这里将advice动态织入bean中，若没有则直接返回bean，不做任何处理
...
//如果工厂方法不为空，则使用工厂方法初始化策略
		...
		//如果存在解析过的FactoryMethod，重新创建bean，否则需要获取构造方法
		if (resolved) {
		...
		// 需要根据参数解析构造方法
		// 检查所有已经注册的候选构造参数，确定用于给定bean的候选构造参数
	 ...
	 * object obtained from FactoryBeans (for example, to auto-staticProxy them).
	 * @see #applyBeanPostProcessorsAfterInitialization
	 */
	@Override
