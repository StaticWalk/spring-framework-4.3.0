...
/**
 * Marker for AOP staticProxy interfaces (in particular: introduction interfaces)
 * that explicitly intend to return the raw target object (which would normally
 * get replaced with the staticProxy object when returned from a method invocation).
 *
 ...
 * as the primary interface of an AOP staticProxy), and hence does not affect
 * other interfaces that a concrete AOP staticProxy may implement.
 *
