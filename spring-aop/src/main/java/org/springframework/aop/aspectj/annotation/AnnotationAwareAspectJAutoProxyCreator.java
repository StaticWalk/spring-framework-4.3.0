 ...
 * advice applied if Spring AOP's staticProxy-based model is capable of applying it.
...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {
	...
	protected List<Advisor> findCandidateAdvisors() {
		...
		// 先执行AbstractAdvisorAutoProxyCreator
		List<Advisor> advisors = super.findCandidateAdvisors();
		// Build Advisors for all AspectJ aspects in the bean factory.
		//找出beanfactory中声明@Aspect注解的类，提取标记为AspectJ注解的增强，结果加入缓存
	...
	protected boolean isInfrastructureClass(Class<?> beanClass) {
		...
		// staticProxy, and if the aspect implements e.g the Ordered interface it will be
